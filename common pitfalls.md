...
<h4>Information</h4>
<p class="caption">
	<a href="/nanodegree">Nanodegree Credentials</a>
	<br>
...
<p class="caption">
	...
	<br>
	<a href="/catalog-api">Developer API</a>
</p>
			...
			<div class="text-center-xs">
				<a href="https://itunes.apple.com/us/app/id819700933?mt=8">
					<img alt="Apple store"
						...
						src="//lh6.ggpht.com/5mY-J8xINNmZ4x_6mbNYmhDWFT_qzG4q4QA2jPzRfiqRjUticf5u0eEEATtX04gbr_KrDSx8SDDBpGRHAWU=s150#w=300&h=88"
						srcset="//lh6.ggpht.com/5mY-J8xINNmZ4x_6mbNYmhDWFT_qzG4q4QA2jPzRfiqRjUticf5u0eEEATtX04gbr_KrDSx8SDDBpGRHAWU=s300#w=300&h=88 2x">
				</a>
				<a href="https://play.google.com/store/apps/details?id=com.udacity.android">
					<img alt="Google Play" class="mobile-button"
						src="//lh5.ggpht.com/Zb2s5Ho_mzDPnb9dBDIqQPpwFrxz1e902ksTnir8Cs_KdrYLvN_TLVK1pmKGbMPgolJ2wIlY23yI9OODDss=s150#w=300&h=88"
						srcset="//lh5.ggpht.com/Zb2s5Ho_mzDPnb9dBDIqQPpwFrxz1e902ksTnir8Cs_KdrYLvN_TLVK1pmKGbMPgolJ2wIlY23yI9OODDss=s300#w=300&h=88 2x">
				</a>
			</div>
		</div>
	</div>
...
<div class="row row-gap-small">
	...
	<script type="text/javascript">
		...
		<script type="text/javascript" src="/media/js/external/libs.min.js?336d6d4063dcb6cee216c40d87cb1489"></script>
<script type="text/javascript" src="/media/js/udacity/udacity.min.js?336d6d4063dcb6cee216c40d87cb1489"></script>
	...
	(function() {
		...
		$.ajax({
			...
			$.each(course_data['courses'], function (index, value) {
	...
	<script src="/media/js/standalone/libs/mathquill.min.js?336d6d4063dcb6cee216c40d87cb1489"></script>

	<link href="/media/wiki/google-code-prettify/prettify.css?336d6d4063dcb6cee216c40d87cb1489" type="text/css" rel="stylesheet" />
	<script type="text/javascript" src="/media/wiki/google-code-prettify/prettify.js?336d6d4063dcb6cee216c40d87cb1489" charset="utf-8"></script>
	<script>
	$(document).ready(function() {
		prettyPrint();
	})
	</script>
	<script type="text/javascript" src="/media/wiki/jquery.highlight.js?336d6d4063dcb6cee216c40d87cb1489"  charset="utf-8"></script>
	<script>
	$(document).ready(function() {
		var rx = /highlight=([^&]+)/;
	...
	<script type="text/javascript">
		...
		angular.module('embedded').constant('cacheVersion', '336d6d4063dcb6cee216c40d87cb1489');
		angular.module('embedded').constant('gitRevision', '18e2812');
		angular.module('embedded').constant('secondsSinceEpoch', 1424796275);
